...
turrets["EXAMPLE_TURRET_NAME"] = {
	...
	hold_time = 0.4, --How long to hold the turret in place after firing, required for pinpoints
	...
	image = Hyperspace.Animations:GetAnimation("example_turret_name_anim"), -- main animation
	...
	glow = Hyperspace.Animations:GetAnimation("example_turret_name_anim_glow"), -- glow, each frame is for 1 charge, so first frame is when the weapon has charged 1 shot, 2nd frame 2 shots, ect
...
table.insert(craftedWeapons, {weapon = "EXAMPLE_TURRET_NAME", match_cost = true, component_amounts = {1}, components = {{"LASER_BURST_2", "LASER_BURST_3"}}} )
